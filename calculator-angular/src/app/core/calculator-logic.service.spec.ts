...
describe('CalculatorLogic', () => {
  beforeEach(() => {
    calculatorFunctions = {
      add: jasmine.createSpy().and.returnValue(10),
      subtract: jasmine.createSpy().and.returnValue(20),
      divide: jasmine.createSpy().and.returnValue(30),
      multiply: jasmine.createSpy().and.returnValue(40)
    };

    calculatorLogic = new CalculatorLogicService(calculatorFunctions);
  });
